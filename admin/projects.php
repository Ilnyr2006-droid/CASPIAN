...
admin_header('Проекты (projects.json)', 'projects');
?>
<div class="card">
  <p class="muted">Редактирование проектов. Перед сохранением создаётся бэкап.</p>
  ...
  <form method="post">
    ...
    <div style="display:flex;gap:10px;margin-top:10px;align-items:center;">
      ...
      <span class="muted">Файл: /data/projects.json</span>
    </div>
  </form>
</div>
<?php admin_footer(); ?>
